...
public class CustomRobotoTextView extends android.support.v7.widget.AppCompatTextView {
    AttributeSet attr;
    ...
    public CustomRobotoTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setCustomFont(Context ctx, AttributeSet attrs) {
        ...
        if (customFont == null) customFont = "fonts/Roboto-Bold.ttf";
